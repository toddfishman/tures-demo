...
**Status (2026-06-14):** items **1 and 4 are DONE and pushed** (body CTAs routed to the planner; Tailwind compiled to `assets/tw.css`, CDN dropped). Items 2, 3, 5, 6 remain. When you do items 5 & 6, **include `write.html`** (it's the landing) — and never untrack it.
